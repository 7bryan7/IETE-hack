...
export default function App() {
  ...
  const [currentView, setCurrentView] = useState('landing'); // landing, calibration, menu, game_reach, game_catch, game_transfer, game_sequence
  ...
  return (
    <div className="app-shell">
      {currentView === 'landing' && (
        <LandingPage
          onStartClick={handleStartLanding}
          onCalibrateClick={handleStartLanding}
        />
      )}
