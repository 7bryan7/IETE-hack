        ...
        <div className="mf-hero-content">
          ...
          <div className="mf-hero-actions">
            <button
              ...
              onClick={() => onStartGame('worlds')}
              id="hero-explore-worlds-btn"
              style={{ background: 'linear-gradient(135deg, #02AE90, #028a73)' }}
            >
              <span>🌲</span> Explore Open Worlds <span>→</span>
            </button>
          ...
          <div className="mf-quick-challenges">
            ...
            <button
              ...
              className="mf-chip"
              onClick={() => onStartGame('worlds')}
              title="Launch Forest Open World"
              style={{ background: '#e0f5f0', borderColor: '#02AE90', color: '#027a65', fontWeight: 700 }}
            >
              🌲 Open Worlds
            </button>
            <button
